...
(setq e2wm:c-max-history-num 30)  ; 履歴の保存数
...
(e2wm:add-keymap
 ...
 '(("<M-left>"  . e2wm:dp-code) ; codeへ変更
   ...
   ("<M-up>"    . e2wm:dp-edbi)  ; docへ変更
   ("<M-down>"  . e2wm:dp-magit) ; magitへ変更
...
;; for 東京×テレビ朝日
;;(setq e2wm:def-plugin-clock-url "http://www.bijint.com/tokyo/tokei_images/%H%M.jpg")
;;(setq e2wm:def-plugin-clock-referer "http://www.bijint.com/tokyo/")
;; for local:北海道
...
;; for bimajo
;(setq e2wm:def-plugin-clock-url "http://www.bijint.com/bimajo/tokei_images/%H%M.jpg")
;(setq e2wm:def-plugin-clock-referer "http://www.bijint.com/bimajo/")
;; for local:秋田
;(setq e2wm:def-plugin-clock-url "http://www.bijint.com/akita/tokei_images/%H%M.jpg")
;(setq e2wm:def-plugin-clock-referer "http://www.bijint.com/akita/")
